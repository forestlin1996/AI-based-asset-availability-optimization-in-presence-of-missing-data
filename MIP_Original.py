...
x61 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 6(A320) to Edinburgh')
x62 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 6(A320) to Glasgow')
x63 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 6(A320) to Aberdeen')
x64 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 6(A320) to Belfast')
x65 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 6(A320) to Manchester')
x71 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 7(A320) to Edinburgh')
x72 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 7(A320) to Glasgow')
x73 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 7(A320) to Aberdeen')
x74 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 7(A320) to Belfast')
x75 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 7(A320) to Manchester')
...
x151 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 15(A321) to Edinburgh')
x152 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 15(A321) to Glasgow')
x153 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 15(A321) to Aberdeen')
x154 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 15(A321) to Belfast')
x155 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 15(A321) to Manchester')
x161 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 16(A321) to Edinburgh')
x162 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 16(A321) to Glasgow')
x163 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 16(A321) to Aberdeen')
x164 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 16(A321) to Belfast')
x165 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 17(A321) to Manchester')
x171 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 17(A321) to Edinburgh')
x172 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 17(A321) to Glasgow')
x173 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 17(A321) to Aberdeen')
x174 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 17(A321) to Belfast')
x175 = MODEL.addVar(lb=0, ub=gurobipy.GRB.INFINITY, vtype=gurobipy.GRB.INTEGER, name='Aircraft 17(A321) to Manchester')
